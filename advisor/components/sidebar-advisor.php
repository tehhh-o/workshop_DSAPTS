<aside class="main-sidebar main-rounded">
    ...
    <a class="sidebar-nav <?php echo $activePage === 'dashboard' ? 'sidebar-nav-active' : ''; ?>" href="dashboard-dev.php">
        <img src="../assets/icons/dashboard.png" alt="">
        <h3>Dashboard</h3>
    </a>
    <a class="sidebar-nav <?php echo $activePage === 'advisor' ? 'sidebar-nav-active' : ''; ?>" href="test-pg.php">
    ...
    <a class="sidebar-nav <?php echo $activePage === 'logs' ? 'sidebar-nav-active' : ''; ?>" href="">
